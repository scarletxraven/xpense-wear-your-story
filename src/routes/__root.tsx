    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-4 text-sm text-muted-foreground">
          The page you’re after may have moved, sold out, or never released.
        </p>
        <div className="mt-8">
          <Link
            to="/"
            className="inline-flex h-11 items-center px-6 bg-primary text-primary-foreground text-xs font-semibold uppercase tracking-[0.2em] hover:bg-accent"
          >
            Back to home
          </Link>
        </div>
